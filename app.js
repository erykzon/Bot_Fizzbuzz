...
// console.log("Exporer FIZZ ►►► " + explorersInNodeAndFizzTrick.length)
...
// console.log("Explorers BUZZ ►►► " + explorersInNodeAndBuzzTrick.length)
...
// console.log("Explorers FIZZBUZZ ►►► " + explorersInNodeAndFizzBuzzTrick.length)
...
const explorersInNodeAndFizzBuzzTrickMix = explorersInNode.map((explorer) => assignFizzBuzzTrickMix(explorer));
console.log("Explorers mix ►►► " + explorersInNodeAndFizzBuzzTrickMix.length)